...
public sealed class FsReadFileToolHandler(
    IFileSystemService fileSystemService,
    ILogger<FsReadFileToolHandler> logger) : IToolHandler<FsReadFileRequest>
{
    public string Name => "fs.read_file";
    ...
    public async ValueTask<Fin<CallToolResult>> Handle(FsReadFileRequest request, CancellationToken ct)
    {
